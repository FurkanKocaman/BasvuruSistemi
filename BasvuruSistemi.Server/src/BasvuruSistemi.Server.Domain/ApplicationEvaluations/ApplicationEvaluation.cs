...
public sealed class ApplicationEvaluation : Entity
{
    ...
    public ApplicationEvaluation(Guid applicationId, Guid evaluationStageId, Guid? assignedCommissionId, Guid? evaluatorId)
    {
        Id = Guid.CreateVersion7();
        ApplicationId = applicationId;
        EvaluationStageId = evaluationStageId;
        AssignedCommissionId = assignedCommissionId;
