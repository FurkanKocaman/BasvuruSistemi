...
<template>
  <div class="mb-4 w-full">
    ...
    <textarea
      ...
      class="w-full px-3 py-2 border rounded-md text-gray-800 dark:text-gray-200 dark:bg-gray-900 dark:border-gray-700 border-gray-200 outline-none focus:border-indigo-600 dark:focus:border-indigo-600"
    ></textarea>
