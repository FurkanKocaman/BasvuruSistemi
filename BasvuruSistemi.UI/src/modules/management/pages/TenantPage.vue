...
<template>
  <main class="w-full h-[100dvh] overflow-auto px-10 pt-20 pb-10 flex justify-center items-center">
    <div
      class="min-w-sm dark:bg-gray-900/40 bg-gray-50 rounded-xl border dark:border-gray-800 border-gray-200"
    >
      <div class="border-b px-5 py-3 dark:border-gray-800 border-gray-200 text-center">
        <span class="text-xl font-base dark:text-gray-50 text-gray-700">Kurum Seç</span>
      </div>
      <div class="px-5 py-3">
        <div
