        ...
        <div class="px-5 py-5">
          ...
          >
            ...
            <table class="w-full text-sm">
              ...
              <tbody class="">
                <tr class="border-b dark:border-gray-700/30 border-gray-200">
                  <td class="py-3 pr-2 pl-4 border-r dark:border-gray-700/30 border-gray-200">1</td>
                  <td class="py-3 px-2 border-r dark:border-gray-700/30 border-gray-200">
                    <span class="cursor-pointer"
                      >2023-2024 KISMİ ZAMANLI ÖĞRENCİ BAŞVURU BELGE TAMAMLAMA</span
                    >
                  </td>
                  <td class="py-3 px-2 border-r dark:border-gray-700/30 border-gray-200">
                    Kesin kabul alan adayların başvurusu
                  </td>
                  ...
                  <td class="py-3 px-2 border-r dark:border-gray-700/30 border-gray-200">
                    <span
                      class="dark:bg-red-500/60 bg-red-500/20 dark:text-red-200 text-red-600 py-0.5 px-1.5 rounded-lg"
                      >Yok</span
                    >
                  </td>
                  <td class="py-3 px-2 border-r dark:border-gray-700/30 border-gray-200">80</td>
                  <td class="py-3 px-2 border-r dark:border-gray-700/30 border-gray-200">
                    <span class="bg-blue-600 py-0.5 px-1.5 rounded-lg text-gray-100">Yayında</span>
                  </td>
                  <td class="py-3 px-2">
            ...
            <div class="flex flex-row justify-between py-4 px-5">
              <div><span class="text-sm">Toplam 30 kayıttan 1 ile 10 arası gösteriliyor</span></div>
              <div class="flex">
                <button
