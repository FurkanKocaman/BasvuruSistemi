...
const getEvaluationForms = async () => {
  if (id) {
    const res = await evaluationService.listEvaluationForms(id);
    if (res) {
      evaluationForms.value = res;
    }
  }
};
                ...
                >
                  ...
                  <td class="py-3 px-2 border-r dark:border-gray-700/30 border-gray-200">
                    <div class="flex items-center">
                      <span class="cursor-pointer" @click="updateCommission(evaluationForm.id)">{{
                        evaluationForm.name
                      }}</span>
                    </div>
                  </td>
                  ...
                  <td class="py-3 px-2">
                    <button class="cursor-pointer pr-1 group" title="Önizleme">
                      <FileSearch
                        @click="updateCommission(evaluationForm.id)"
